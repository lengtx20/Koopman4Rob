...
def main():
    ...
    parser.add_argument(
        "--file_path",
        type=str,
        default="logs/test/ewc_task1.pt",
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Task ID, usually set to 1 when single training",
    )
    parser.add_argument(
        "--threshold", type=float, default=None, help="Threshold for visualization"
    )
    ...
    if threshold is not None:
        ...
        ewc_analyzer.thresholded_visualize_fisher(
            threshold=threshold, save_dir="logs", save_fig=False
        )
