...
class CyberDogDataProcessor:
    ...
    def process_data(self):
        ...
        while current_time <= max_timestamp:
            ...
            while (
                motion_control is None
                and motion_control_index < len(self.timestamps) - 1
            ):
            ...
            while (
                state_estimator is None
                and state_estimator_index < len(self.timestamps) - 1
            ):
            ...
            while (
                leg_control_data is None
                and leg_control_data_index < len(self.timestamps) - 1
            ):
